...
public class ZipcodeProcessor 
{
  ...
  public List<ZipcodeGetterSetter> stripZipcode() {
  ...
  public ZipcodeGetterSetter validateAndAdd(String[] zipRange) 
  {
    ...
    if (validateZipcodeRange(lowerBound, upperBound) == true)
      zipcode = new ZipcodeGetterSetter(lowerBound, upperBound);
    return zipcode;
  }

  public ZipcodeGetterSetter getZipcodeRange(String zipcodeRange) {
    return validateAndAdd(zipcodeRange.replaceAll("\\[|\\]", "").split(","));
  }

  public List<ZipcodeGetterSetter> loadZipcode(String[] zipcodeRange) {
    List<ZipcodeGetterSetter> zipcodesList = new LinkedList<ZipcodeGetterSetter>();
